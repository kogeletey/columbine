...
function findPush1Push1SStorePattern(filePath: string): void {
    try {
        ...
        for (let i = 0; i < lines.length - 2; i++) {
            ...
            if (instruction1 === 'PUSH1' && instruction2 === 'PUSH1' && instruction3 === 'SSTORE') {
                ...
                console.log(`Found PUSH1 PUSH1 SSTORE pattern at:`);
...
// Usage
findPush1Push1SStorePattern('./result/opcode.USDT');